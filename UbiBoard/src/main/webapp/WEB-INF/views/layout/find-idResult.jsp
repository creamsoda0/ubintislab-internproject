...
<title>서산시청 통합로그인 - 아이디 찾기 완료</title>
</head>
<body>
		...
		<div class="wrap">
			...
			<div class="step">
				<table cellpadding="0" cellspacing="0">
					...
					<tr>
						<td>본인인증</td>
						<td class="step_select">통합회원 아이디찾기 완료</td>
					</tr>
				</table>
			</div>
			<div class="mt50 text">
				<h3>통합회원 아이디찾기 완료</h3>
				<p class="bullet01 mt20">통합회원 아이디찾기가 완료되었습니다. 회원님의 통합 아이디는 아래와 같습니다.</p>
				
				<div class="ok mt30" style="height:161px;">
					<p style="font-size: 16px; margin-top: 40px;">
						<strong style="color:#000;">${resultUser.name}</strong> 회원님의 통합로그인 아이디는 <br/>
						<span style="color:#0054a6; font-weight:bold; font-size:24px;">${resultUser.userId}</span> 입니다.
					</p>
				</div>
				<div class="btn mt40 t_center">
					<button class="btn_blue" onclick="location.href='${contextPath}/member/goLoginPage'">통합로그인</button>
					<button class="btn_gray ml10" onclick="location.href='${contextPath}/member/findPw'">비밀번호 찾기</button>
				</div>
