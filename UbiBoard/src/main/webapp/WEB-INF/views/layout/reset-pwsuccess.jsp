...
<title>서산시청 통합로그인 - 비밀번호 변경 완료</title>
</head>
<body>
			...
			<div class="step">
				<table cellpadding="0" cellspacing="0">
					...
					<tr>
						<td>본인인증</td>
						<td>비밀번호 입력</td>
						<td class="step_select">비밀번호 변경 완료</td>
					</tr>
				</table>
			</div>
			<div class="mt50 text">
				<h3>비밀번호 변경 완료</h3>
				<p class="bullet01 mt20">통합 비밀번호가 새롭게 변경되었습니다.</p>
				
				<div class="ok mt30" style="height:161px;">
					<p style="padding-top: 40px;">새로운 비밀번호로 변경되었습니다.</p>
