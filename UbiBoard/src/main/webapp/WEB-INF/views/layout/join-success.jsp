	...
	<div id="content">
		...
		<div class="wrap">
			<div class="step">
				<table class="reg_step" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<p>본인확인</p></div></td>
						<td><div class="step04"><span>STEP 04</span><br />
						<p>개인정보입력</p></div></td>
						<td class="step_select"><div class="step05"><span>STEP 05</span><br />
						<p>가입완료</p></div></td>
					</tr>
				</table>
			</div>
			<div class="mt50 text">
				...
				<div class="ok" style="height:475px;">
					<img src="${contextPath}/static/member/img/reg_ok.png" alt="회원가입완료" class="mb25"><br />
					서산시청 통합 회원가입이 완료되었습니다.<br />
					가입하신 아이디로 로그인을 하실 수 있습니다.
